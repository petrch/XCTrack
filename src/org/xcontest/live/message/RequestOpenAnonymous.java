...
public class RequestOpenAnonymous extends RequestOpen {
	/**
	 * 
	 ...
	 * @param isPublic
	 */
	public RequestOpenAnonymous(String firstname, String surname, String nickname, String trackType, String competitionKey, boolean isPublic) {
	...
	public JSONObject toJSON() {
		try {
			...
			j.put("action","open-anonymous");
			j.put("requestId", getRequestId());
			j.put("firstname",_firstname);
			j.put("surname",_surname);
